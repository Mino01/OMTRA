...
NPNDE_MAP = ['C', 'N', 'O', 'S', 'F', 'P', 'Cl', 'Br', 'I', 'Si', 'Pd', 'Ca', 'Sc', 'Al', 'Pt', 'Cr', 'Rh', 'Mo', 'Y', 'Cu', 'Sm', 'Bi', 'Ir', 'Be', 'Pb', 'Kr', 'As', 'Sn', 'Lu', 'Co', 'Ni', 'K', 'Am', 'Rb', 'Gd', 'Ce', 'Ba', 'Au', 'Na', 'Th', 'Pr', 'Yb', 'Ti', 'Mg', 'Sr', 'Cs', 'Tl', 'B', 'Xe', 'Cm', 'Li', 'Zr', 'Cf', 'Ag', 'Cd', 'Mn', 'Eu', 'In', 'Hg', 'W', 'Tb', 'La', 'Sb', 'Te', 'Se', 'Zn', 'Os', 'Ga', 'Fe', 'Nd', 'Pu', 'V', 'U', 'Ru', 'Re']
